...
__global__ void insertParticlesKernel(const float *posX, const float *posY, const float *posZ, OctreeNode *nodes, int n, int *nodeCounter, int *leafNodeIdx, const int *indices, int startIdx, int batchSize)
{
...
// ============================================================================
// SIMULATION STEP (Benchmark verzija)
// ============================================================================
...
int main()
{
    printf("Pokretanje Benchmarka za N = %d...\n", N);

    // Alokacija na hostu (CPU)
    ...
    for (int frame = 0; frame < 1000; frame++)
    {
        ...
        printf("%-10d | %-15.3f | %-10.1f\n", frame, milliseconds, fps);
    }
